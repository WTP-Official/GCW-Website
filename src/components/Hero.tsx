...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-white text-white">
      <div className="absolute top-[15px] bottom-0 left-1/2 w-full max-w-[1360px] -translate-x-1/2">
        {hero.video ? (
          <video
            src={hero.video}
            poster={hero.image}
      ...
      <div className="relative mx-auto max-w-[1360px] px-3 py-12 sm:py-16 lg:py-20">
        <div className="ml-[60px] max-w-[660px]">
          <Reveal>
